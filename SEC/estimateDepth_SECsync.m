function d_hat = estimateDepth_SECsync(d, c, p, N, M, A, e_s, e_a, e_i, f_mod, T)
...
%% OK so this is what we would change to add more cameras i guess, i don't really know what we would put here though  uhhh
